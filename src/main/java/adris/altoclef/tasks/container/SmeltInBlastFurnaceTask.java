...
public class SmeltInBlastFurnaceTask extends ResourceTask {
    ...
    protected boolean isEqualResource(ResourceTask other) {
        if (other instanceof SmeltInBlastFurnaceTask task) {
            return task._doTask._target.equals(_doTask._target)
                    && task._doTask._ignoreMaterials == _doTask._ignoreMaterials;
        }
        return false;
    }
    ...
    static class DoSmeltInBlastFurnaceTask extends DoStuffInContainerTask {
        ...
        protected Task onTick(AltoClef mod) {
            ...
            if (_blastFurnaceCache.burningFuelCount <= 0 && StorageHelper.calculateInventoryFuelCount(mod) < fuelNeeded) {
                ...
                return new CollectFuelTask((int) Math.ceil(fuelNeeded + 1));
            }
        ...
        protected Task containerSubTask(AltoClef mod) {
            ...
            if (!_allMaterials.matches(material.getItem()) || neededMaterialsInSlot > material.getCount()) {
                ...
                return new MoveItemToSlotFromInventoryTask(BlastFurnaceSlot.INPUT_SLOT_MATERIALS, new ItemTarget(materialTarget, neededMaterialsInSlot - materialsAlreadyIn));
            }
            ...
            if (fuel.isEmpty() || ItemHelper.isFuel(fuel.getItem())) {
                ...
                if (needs > 0) {
                    ...
                    if (bestStack != null) {
                        ...
                        return new MoveItemToSlotFromInventoryTask(BlastFurnaceSlot.INPUT_SLOT_FUEL, new ItemTarget(bestStack.getItem(), bestStack.getCount()));
                    }
                }
            }
