...
public class TaskCatalogue {
    ...
    static {
        /// DEFINE RESOURCE TASKS HERE
        {
            ...
            put("wither_skeleton_skull", new Item[]{Items.WITHER_SKELETON_SKULL},
                    count -> new adris.altoclef.tasks.entity.KillAndLootTask("wither_skeleton", new ItemTarget(Items.WITHER_SKELETON_SKULL, count))).forceDimension(Dimension.NETHER);
            alias("wither_skull", "wither_skeleton_skull");
            ...
            simple("water_bucket", Items.WATER_BUCKET, CollectWaterBucketTask::new);
            simple("lava_bucket", Items.LAVA_BUCKET, CollectLavaBucketTask::new);
            {
                String a = "paper";
